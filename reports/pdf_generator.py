...
class NumberedCanvas(canvas.Canvas):
    """Two-pass canvas for adding Ledger AI running headers and page numbers."""
    ...
    def draw_header_and_footer(self, page_count: int):
        ...
        self.setFont("Helvetica", 8)
        self.setFillColor(colors.HexColor("#64748b"))
        self.drawString(36, 26, "Confidential — Generated by Ledger AI Engine")
...
def format_engine_decision(t: Dict[str, Any]) -> str:
    """Format a human-readable, distinct decision string showing stage/rule that produced the call."""
